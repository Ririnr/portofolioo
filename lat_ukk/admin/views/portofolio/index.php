...
<html lang="en">
  <head>
    ...
    <title>My Portofolio | Ririn Rianti</title>
  </head>
  <body id="home">
    <!-- Navbar -->
    ...
    <section class="jumbotron text-center">
      <img src="asset/img/foto.jpeg" alt="Ririn Rianti" width="200" class="rounded-circle img-thumbnail" />
      <h1 class="display-4">Ririn Rianti</h1>
      <p class="lead">MAHASISWI</p>
      <p class="lead">SMKN4 TASIKMALAYA</p>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#ffffff"
          fill-opacity="1"
          d="M0,128L48,133.3C96,139,192,149,288,138.7C384,128,480,96,576,80C672,64,768,64,864,96C960,128,1056,192,1152,192C1248,192,1344,128,1392,96L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
        ></path>
      </svg>
    </section>
   ...
   <div class="col-md-4">
    ...
    <section id="contact">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          fill="#0d6efd"
          fill-opacity="1"
          d="M0,160L40,176C80,192,160,224,240,213.3C320,203,400,149,480,149.3C560,149,640,203,720,218.7C800,235,880,213,960,176C1040,139,1120,85,1200,58.7C1280,32,1360,32,1400,32L1440,32L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"
        ></path>
      </svg>
    </section>
    <!-- akhir contact -->
    ...
    <footer class="bg-primary text-white text-center pb-5">
      <p>Created with <i class="bi bi-heart-fill text-danger"></i> by <a href="https://www.instagram.com/_ririnriantii/" class="text-white fw-bold">Ririn Rianti</a></p>
    </footer>
    <!-- Akhir Footer -->
